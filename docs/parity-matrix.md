...
| XLSX write | Dynamic single-sheet `SaveAs`, path/stream | Partial | Scalars, temporal values, overwrite and Excel epoch parity verified; explicit schema and styles remain |
